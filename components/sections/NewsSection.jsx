...
<div className='flex flex-col lg:flex-row justify-between max-w-[1028px] mx-auto py-[60px] px-5'>
     <div className='flex flex-col w-[568px] gap-2'>
<div className='grid grid-cols-2 h-[216px] '>
        ...
        <div className='flex flex-col justify-between px-[30px]'>
            <div>
               ...
               <p className='text-[24px] font-[300] leading-[30px] mr-[25px]'>Earthquakes Turkey and Syria</p>
            </div>
...
<div className='grid grid-cols-2 h-[216px]'>
     ...
     <div className='w-full lg:max-w-[340px] flex flex-col md:flex-row lg:flex-col gap-4 justify-between'>
     <div className='grid grid-cols-3'>
            ...
            <img className="h-full object-cover" src="https://assets.vu.nl/d8b6f1f5-816c-005b-1dc1-e363dd7ce9a5/45e509b2-1cf3-49a7-b40d-53310c2e2219/7%20ton%20voor%20welzijn%20Oekrai%CC%88ne%20vluchtelingen_afb_1250x600.jpg" alt="" />
               ...
               <div className='col-span-2 pl-[30px] flex flex-col'>
